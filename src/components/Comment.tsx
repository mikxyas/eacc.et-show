...
export default function Comment({ post_id, comment }) {
    ...
    return (
        <div className='mt-2'>
            <div className='flex ml-5 gap-1 items-start text-gray-300' style={{ fontSize: '8pt' }}>
            ...
            <div style={{ fontSize: '9pt' }} className={comment.zap_count > 0 ? 'ml-10 -mt-5  md:w-2/3 ' : 'ml-10  md:w-2/3 '}>
                <p>
                    {comment.content}
                </p>
